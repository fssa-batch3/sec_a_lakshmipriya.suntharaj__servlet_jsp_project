...
%>
	<div class="contact-form">
		...
		<form id="addrecipe"action="UpdateRecipeServlet" method="post">
			...
			<textarea  id="Ingredient" <%=recipe.getIngredients() %>name="ingredients"> <%=recipe.getIngredients() %></textarea>
			
			<label  for="step1">Step</label> 
			<input type="text" id ="Step" value="<%=recipe.getInstructions() %>" required id="Step1" name="instructions" /> 
